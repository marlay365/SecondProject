              ...
              <form action="login.do" method="post" class="p-5 bg-white">
                ...
                <div class="row form-group">
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="password" id="subject" name="password" class="form-control" placeholder="Please enter your password." required>
                  </div>
                </div>
  
                <div class="row form-group">
                  <div class="col-md-12">
                    <input type="submit" value="Login" class="btn btn-danger btn-md text-white">
                  </div>
                </div>
